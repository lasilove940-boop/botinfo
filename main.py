...
/skills - используй для того, чтобы добавить навык для своего проекта
/projects - используй чтобы посмотреть свои проекты
/delete - используй для того, чтобы удалить проект
/update_projects - используй для того, чтобы обновить проект
